...
namespace ShowRoomManagement.PresentationLayer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private IModelManager _modelManager = new ModelManager();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("GetBike", "Admin");
                    }
                    else
                    {
        ...
        {
            ViewBag.roles = new SelectList(_dbContext.Roles.ToList(), "Name", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _modelManager.AddCustomer(customerModel);
                    // For more information on how to enable account confirmation and password reset please visit https://go.microsoft.com/fwlink/?LinkID=320771
                    // Send an email with this link
                    // string code = await UserManager.GenerateEmailConfirmationTokenAsync(user.Id);
                    // var callbackUrl = Url.Action("ConfirmEmail", "Account", new { userId = user.Id, code = code }, protocol: Request.Url.Scheme);
                    // await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");
                    if (model.UserRole.Equals("Admin"))
                        return RedirectToAction("GetBike", "Admin");
                    else if (model.UserRole.Equals("Customer"))
                        return RedirectToAction("CustomerIndex", "Customer");
